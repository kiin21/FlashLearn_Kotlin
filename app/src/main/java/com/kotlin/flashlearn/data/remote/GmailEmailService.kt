...
class GmailEmailService @Inject constructor() {
     ...
     */
    suspend fun sendPasswordResetEmail(toEmail: String, resetLink: String): Result<Unit> = withContext(Dispatchers.IO) {
        runCatching {
        ...
        return """
            ...
            <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; 
                ...
                <div style="max-width: 480px; margin: 0 auto; background: white; border-radius: 12px; 
                    ...
                    <!-- Header -->
                    <div style="background: linear-gradient(135deg, #6200EE 0%, #3700B3 100%); 
                    ...
                    <div style="padding: 32px;">
                        ...
                        <div style="text-align: center; margin: 32px 0;">
                            <a href="$httpsLink" 
                               style="display: inline-block; background: #6200EE; color: white; 
